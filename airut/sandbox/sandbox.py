...
from airut.sandbox.task import AgentTask, CommandTask, NetworkSandboxConfig
...
class Sandbox:
    ...
    def ensure_image(
        ...
        *,
        ...
        Args:
            ...
            passthrough_entrypoint: When True, use the passthrough
                entrypoint (``exec "$@"``) instead of the agent
    ...
    def create_command_task(
        ...
        *,
        ...
        """Create a task for sandboxed command execution.

        Unlike create_task(), this creates a CommandTask for running
        arbitrary commands (not Claude Code). There is no event log
        or Claude session directory.
