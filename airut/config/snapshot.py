...
class ConfigSnapshot[T]:
    ...
    def to_dict(self, *, include_defaults: bool = False) -> dict[str, Any]:
        ...
        for f in dataclasses.fields(self._instance):  # ty:ignore[invalid-argument-type]
    ...
    def __repr__(self) -> str:
        ...
        n_total = len(dataclasses.fields(self._instance))  # ty:ignore[invalid-argument-type]
