...
2. **Server controls the entrypoint**: The sandbox library generates the
   container entrypoint in code (`lib/sandbox/_entrypoint.py`). This is the
...
Layer 2: Server Overlay (generated in code)
  Source: lib/sandbox/_entrypoint.py (generated entrypoint script)
...
- The entrypoint script is generated in code by `lib/sandbox/_entrypoint.py`
...
The entrypoint script (generated by `lib/sandbox/_entrypoint.py`) performs two
