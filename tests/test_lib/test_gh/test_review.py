...
class TestGetReviewStatus:
    ...
    def test_uses_current_pr_when_none(self) -> None:
        ...
        with (
            ...
            patch("lib.gh.review._fetch_reviews", return_value={}),
            patch("lib.gh.review._fetch_comments", return_value=[]),
            patch("lib.gh.review._count_unresolved_threads", return_value=0),
        ):
    ...
    def test_returns_status_with_reviews_and_comments(self) -> None:
        ...
        with (
            patch("lib.gh.review._fetch_reviews", return_value=mock_reviews),
            patch("lib.gh.review._fetch_comments", return_value=mock_comments),
            patch("lib.gh.review._count_unresolved_threads", return_value=2),
        ):
...
class TestFetchReviews:
    ...
    def test_returns_reviews(self) -> None:
        ...
        with patch("lib.gh.review.subprocess.run") as mock_run:
